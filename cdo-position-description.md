...
*	Lead the city efforts to track data collections, data purchases, databases, physical data models, and linkages between datasets.
*	Improve data quality and how we measure data quality
*	Ensure data is available, reliable, consistent, accessible, secure, and timely to support the mission and activities of the city.
*	Align and standardizing data models
*	Head up city wide data-working group 
...
The primary role of Chief Data Officer is insuring the City has the right data usable in the right ways to fulfill its mission.
...
1.	Appoint an agency Chief Data Officer and Data Officers or points of contacts in each Agency, Department, and Office
2.	Have CDO conduct Zero-based reviews of all data collections
3.	Maintain a central inventory of the City’s data collections and datasets 
...
The City’s CDO role is to be the executive business lead, ensuring that enterprise data is available, reliable, consistent, accessible, secure, and timely to support the mission and activities of the city.  This includes:
...
The CDO works closely with the city leadership to ensure data is being developed as a viable resource for current and future needs both inside and outside of specific IT systems. As the principle Data Steward Data Scientist for the agency, the CDO:
...
*	Works with the CIO to develop data management policies and practices to support the mission of the city
*	Decreases the cost of collecting, managing, and sharing data while increasing the value of the data to the city
...
*	Reaches out to industry, academics, other branches of government, and the public to promote and City data and data services; travels to events to promote City data
...
*	Participates in inter-department data coordination activities. 
*	Manages  Open Government Data activities

The CDO is responsible for data reform and modernization--how the city collects, uses, manages, and shares data--toward the Mayor’s stated goal of “fact-based, data-driven decision-making.” This role includes:

*	Coordinates the Zero-Based Data Review of all city collections
*	Ensure data supports specific policy-related activities
*	Working with stakeholders to plan future data needs
*	Coordinating annual or bi-annual data reviews of the city data
*	Delivering reports to the City Executives on progress with data reform
*	Prioritizing large scale data projects in conjunction with program owners

### A Vision of Success

Success for the CDO is developing culture of data sharing within the organization and planning to make data available to share as part of City process, rule makings and IT system design. Data management, well-led by the CDO, should be a profit center for the enterprise, or a means to avoiding costs and increasing productivity. Success looks like:
...
*	Exposing City tools and data in manner that helps speeds products and innovation to markets
...
Executing depends on the current City need and data asset maturity.  The vision involves the development of data team oriented toward the technical and data scientist to envision, prototype, evangelize, implement, and support data platform distinct from individual IT applications. Like other IT-related areas, the CDO needs some practicing technologists to support the multitude of projects involving specific data components and having sufficient bandwidth to focus on improving linkages between systems and enterprise data assets. 
...
Below is a bullet list of and example data dream team for a medium sized city. These functions would also apply under Scenario One, but they would be more integrated with existing roles existing resources are pursuing.  These are presented purely for example.
...
*	A senior DBA or dedicated time from DBA to manage the Enterprise Information Catalog, to assist with proper data documentation and management and to interface smoothly with city’s DBA
*	Scalable computing resources for the processing and data mining
*	Project management and/or COTR resource to keep project reporting and contract management inline with City policy
